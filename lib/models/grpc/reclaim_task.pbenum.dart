...
class EventCategory extends $pb.ProtobufEnum {
  static const EventCategory WORK = EventCategory._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'WORK');
  static const EventCategory PERSONAL = EventCategory._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'PERSONAL');
...
class TaskStatus extends $pb.ProtobufEnum {
  static const TaskStatus UNKNOWN_STATUS = TaskStatus._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'UNKNOWN_STATUS');
  static const TaskStatus SCHEDULED = TaskStatus._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'SCHEDULED');
  static const TaskStatus IN_PROGRESS = TaskStatus._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'IN_PROGRESS');
  static const TaskStatus COMPLETED = TaskStatus._(
      ...
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'COMPLETED');
  static const TaskStatus NEW = TaskStatus._(
      4,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'NEW');
  ...
  static final $core.Map<$core.int, TaskStatus> _byValue =
      $pb.ProtobufEnum.initByValue(values);
...
class TaskType extends $pb.ProtobufEnum {
  static const TaskType UNKNOWN_TYPE = TaskType._(
      0,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'UNKNOWN_TYPE');
  static const TaskType TASK = TaskType._(
      1,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'TASK');
  static const TaskType HABIT = TaskType._(
      2,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'HABIT');
  static const TaskType DAILY = TaskType._(
      3,
      const $core.bool.fromEnvironment('protobuf.omit_enum_names')
          ? ''
          : 'DAILY');
