...
class Task extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Task', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'task'), createEmptyInstance: create)
    ...
    ..pc<TaskInstance>(24, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'instances', $pb.PbFieldType.PM, subBuilder: TaskInstance.create)
  ...
  factory Task({
    ...
    $core.Iterable<TaskInstance>? instances,
  }) {
  ...
  @$pb.TagNumber(24)
  $core.List<TaskInstance> get instances => $_getList(23);
}

class TaskInstance extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TaskInstance', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'task'), createEmptyInstance: create)
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'taskId', $pb.PbFieldType.O3, protoName: 'taskId')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'eventId', protoName: 'eventId')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'eventKey', protoName: 'eventKey')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status')
    ..aOM<$0.Timestamp>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'start', subBuilder: $0.Timestamp.create)
    ..aOM<$0.Timestamp>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'end', subBuilder: $0.Timestamp.create)
    ..a<$core.int>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'index', $pb.PbFieldType.O3)
    ..aOB(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pinned')
    ..hasRequiredFields = false
  ;

  TaskInstance._() : super();
  ...
  factory TaskInstance.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory TaskInstance.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  TaskInstance clone() => TaskInstance()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TaskInstance copyWith(void Function(TaskInstance) updates) => super.copyWith((message) => updates(message as TaskInstance)) as TaskInstance; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static TaskInstance create() => TaskInstance._();
  TaskInstance createEmptyInstance() => create();
  static $pb.PbList<TaskInstance> createRepeated() => $pb.PbList<TaskInstance>();
  @$core.pragma('dart2js:noInline')
  static TaskInstance getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<TaskInstance>(create);
  static TaskInstance? _defaultInstance;
  ...
  @$pb.TagNumber(3)
  $core.String get eventKey => $_getSZ(2);
  @$pb.TagNumber(3)
  set eventKey($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasEventKey() => $_has(2);
  @$pb.TagNumber(3)
  void clearEventKey() => clearField(3);
  ...
  @$pb.TagNumber(5)
  $0.Timestamp get start => $_getN(4);
  @$pb.TagNumber(5)
  set start($0.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasStart() => $_has(4);
  @$pb.TagNumber(5)
  void clearStart() => clearField(5);
  @$pb.TagNumber(5)
  $0.Timestamp ensureStart() => $_ensure(4);

  @$pb.TagNumber(6)
  $0.Timestamp get end => $_getN(5);
  @$pb.TagNumber(6)
  set end($0.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasEnd() => $_has(5);
  @$pb.TagNumber(6)
  void clearEnd() => clearField(6);
  @$pb.TagNumber(6)
  $0.Timestamp ensureEnd() => $_ensure(5);
