...
class Task extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<EventCategory>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'eventCategory',
        $pb.PbFieldType.OE,
        protoName: 'eventCategory',
        defaultOrMaker: EventCategory.WORK,
    ...
    ..e<TaskStatus>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'status',
        $pb.PbFieldType.OE,
        defaultOrMaker: TaskStatus.UNKNOWN_STATUS,
    ...
    ..a<$core.int>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'maxChunkSize',
        $pb.PbFieldType.O3,
        protoName: 'maxChunkSize')
    ..aOB(
        12,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'alwaysPrivate',
        protoName: 'alwaysPrivate')
    ..aOB(
        13,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
    ...
    ..e<TaskType>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'type',
        $pb.PbFieldType.OE,
        defaultOrMaker: TaskType.UNKNOWN_TYPE,
    ...
    ..e<TaskType>(
        ...
        $pb.PbFieldType.OE,
        protoName: 'recurringAssignmentType',
        defaultOrMaker: TaskType.UNKNOWN_TYPE,
        valueOf: TaskType.valueOf,
        enumValues: TaskType.values)
    ..aOS(
  ...
  @$pb.TagNumber(4)
  set eventCategory(EventCategory v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(5)
  set eventSubType($core.String v) {
    $_setString(4, v);
  }
  ...
  @$pb.TagNumber(7)
  set timeChunksRequired($core.int v) {
    $_setSignedInt32(6, v);
  }
  ...
  @$pb.TagNumber(8)
  set timeChunksSpent($core.int v) {
    $_setSignedInt32(7, v);
  }
  ...
  @$pb.TagNumber(9)
  set timeChunksRemaining($core.int v) {
    $_setSignedInt32(8, v);
  }
  ...
  @$pb.TagNumber(22)
  set recurringAssignmentType(TaskType v) {
    setField(22, v);
  }
